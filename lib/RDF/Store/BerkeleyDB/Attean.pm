package RDF::Store::BerkeleyDB::Attean;
...
RDF::Store::BerkeleyDB::Attean - The great new RDF::Store::BerkeleyDB::Attean!
...
Perhaps a little code snippet.
    ...
    use RDF::Store::BerkeleyDB::Attean;

    my $foo = RDF::Store::BerkeleyDB::Attean->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc RDF::Store::BerkeleyDB::Attean
...
1; # End of RDF::Store::BerkeleyDB::Attean
